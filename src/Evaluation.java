...

	{
...

		{
...

			{
				...
				if(echiquier[i][j].isOccupe() == 'p' || echiquier[i][j].isOccupe() == 'c' || echiquier[i][j].isOccupe() == 't' || echiquier[i][j].isOccupe() == 'f' || echiquier[i][j].isOccupe() == 'd' || echiquier[i][j].isOccupe() == 'r' )
